...
class Terms extends Component{
    render(){
        return(
            <nav>
                <h1>
                    EASEL Terms of Service
                </h1>
                <p>
                    Please read these terms of service ("terms", "terms of service") carefully before using
                    the EASEL Mobile or Web Application (the "service") operated by EASEL ("us", 'we", "our").
                </p>
                <h2>
                    Conditions of Use
                </h2>
                ...
                <p>
                    ...
                    property of EASEL and/or its content creators and protected by international copyright laws.
                    The entire compilation of the content found on this website is the exclusive property of EASEL,
                    with copyright authorship for this compilation by EASEL.
                </p>
                <h2>
                    Communications
                </h2>
                ...
                <p>
                    By visiting this website, you agree that the laws of the State of Indiana and the laws of the
                    United States of America, without regard to principles of conflict of laws, will govern these
                    terms of service, or any dispute of any sort that might come between Lately and you, or its
                ...
                <p>
                    ...
                    shall be arbitrated by state or federal court in Indiana and you consent to the exclusive
                ...
                <p>
                    ...
                    your content, you grant Lately non-exclusive, royalty-free and irrevocable right to use, reproduce,
